...
export const metricOptionsLepto = [
...
export const getRadiusForLeptoValue = (value: number, maxValue: number) => {
  if (!value) return 4;
...
export const formatLeptoValue = (value: number | null | undefined, metricToShow: string) => {
...
export const generateLeptoLegendItems = (maxValue: number, metricToShow: string) => {
  if (metricToShow.includes('_change')) {
